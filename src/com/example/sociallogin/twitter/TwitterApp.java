...
public class TwitterApp {
	 ...
	 * public static final String OAUTH_CALLBACK_HOST = "callback"; public
	 * static final String CALLBACK_URL = OAUTH_CALLBACK_SCHEME + "://" +
	 * OAUTH_CALLBACK_HOST;
	 */
	public static final String CALLBACK_URL = "twitterapp://calback";
	...
	public boolean hasAccessToken() {
		//Log.v("", "Access token is " + mAccessToken.getToken());
		return (mAccessToken == null) ? false : true;
	}

	public String getAccessToken() {
		return (mAccessToken == null) ? null : mAccessToken.getToken();
	}

	public String getAccessTokenSecret() {
		return (mAccessToken == null) ? null : mAccessToken.getTokenSecret();
	}
